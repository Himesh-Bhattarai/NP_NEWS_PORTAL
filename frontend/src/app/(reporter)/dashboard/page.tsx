                          ...
                          <Card className="shadow-sm rounded-none">
                              <CardContent className="p-4">
                                  <div className="space-y-1">
                                      ...
                                      <Link
                                          to = "/reporter-dashboard/new-article"
                                      ...
                                      <Link
                                          to = "/reporter-dashboard/my-articles"
                                          className="flex items-center space-x-2 p-2 text-foreground hover:bg-muted rounded-none"
                                      >
                                      ...
                                      <Link
                                          to = "/reporter-dashboard/analytics"
                                          className="flex items-center space-x-2 p-2 text-foreground hover:bg-muted rounded-none"
                                      >
                                      ...
                                      <Link
                                          to = "/reporter-dashboard/comments"
                                          className="flex items-center space-x-2 p-2 text-foreground hover:bg-muted rounded-none"
                                      >
                                      ...
                                      <Link
                                          to = "/reporter-dashboard/fact-check"
                                          className="flex items-center space-x-2 p-2 text-foreground hover:bg-muted rounded-none"
                                      >
                                      ...
                                      <Link
                                          to = "/reporter-dashboard/settings"
                                          className="flex items-center space-x-2 p-2 text-foreground hover:bg-muted rounded-none"
                                      >
