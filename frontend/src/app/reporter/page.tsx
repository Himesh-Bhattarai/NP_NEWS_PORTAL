...
import {
    BarChart3, BookOpen, Calendar, CheckCircle, Clock, Edit, Eye, FileText, Home, Image, MessageSquare, PenTool, Plus, Settings, ThumbsUp,
    AlertCircle,
    Bell,
    Search,
    MoreHorizontal,
...
import { User, FileCheck, LogOut, Menu, X } from "lucide-react"
...
import { UserSidebar } from "@/components/features/user-sidebar"
import {AddContentButton} from '@/components/features/AddContentButton'
                                ...
                                <Card className="shadow-sm rounded-none">
                                    ...
                                    <CardContent>
                                        <Tabs defaultValue="published">
                                            ...
                                            <TabsContent defaultValue="published" className="mt-0">
                                                <div className="space-y-4">
                                                    {[1, 2, 3].map((item) => (
                                                        <div
                                                            key={item}
                                            ...
                                            <TabsContent defaultValue="drafts" className="mt-0">
                                                <div className="space-y-4">
                                                    {[1, 2].map((item) => (
                                                        <div
                                                            key={item}
                                            ...
                                            <TabsContent defaultValue="pending" className="mt-0">
                                                <div className="space-y-4">
