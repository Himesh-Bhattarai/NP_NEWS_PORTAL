          ...
          <div className="min-h-screen bg-background">
              ...
              <div className="bg-primary text-primary-foreground py-2">
                  <div className="container mx-auto px-4">
                      <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-4 text-xs">
                              <Link to ="/about" className="elegant-underline">
                                  About
                              </Link>
                              <Link to ="/contact" className="elegant-underline">
                                  Contact
                              </Link>
              ...
              <div className="md:hidden fixed bottom-0 left-0 right-0 bg-card shadow-[0_-2px_10px_rgba(0,0,0,0.1)] z-10 py-2 px-4">
                  <div className="flex items-center justify-between">
                      ...
                      <Link to ="/trending" className="flex flex-col items-center text-xs">
                          <TrendingUp className="h-5 w-5 mb-1" />
                          <span>Trending</span>
                      </Link>
                      <Link to ="/videos" className="flex flex-col items-center text-xs">
